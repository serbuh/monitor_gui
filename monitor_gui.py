...
class Window():
    def __init__(self, master, conn):
        ...
        # Get first
        self.update_labels_list(self.conn.recv())
    ...
    def update_labels_text(self):
        ...
        #try:
        #    
        #except AttributeError: # first run => curr_fields_dict does not exist
        #    self.update_labels_list(status_dict)
        #except KeyError: # received message with unknown label
        #    self.update_labels_list(status_dict)
        self.master.after(10, self.update_labels_text)

    def update_labels_list(self, status_dict):
        print("Updating labels list")
